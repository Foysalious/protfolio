...
<title>Foysal Rahman | Web Developer</title>
<link rel="icon" href="favicon.png" type="image/png">
<link href="{{asset('frontend/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="{{asset('frontend/js/jquery.fancybox.css')}}" type="text/css" media="screen" />
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="top_left_cont intro zoomIn wow animated"> 
              <h2>I am Foysal <br> <strong>Full Stack Developer</strong></h2>
              <p>
			  Hi, my name is Foysal Rahman and I love creating unique app and Love to take challenges with modern innovation
 </p>
	  ...
	  <div class="row">
						<div class="col-lg-12 about-us">
							...
							<p>
									...
									<div class="barWrapper">
									 <span class="progressText"><B>Laravel</B></span>
									<div class="progress ">
									...
									<div class="barWrapper">
									 <span class="progressText"><B>Python</B></span>
									<div class="progress">
...
<section id="Portfolio" class="content"> 
  ...
  <div class="portfolio"> 
    ...
    <!-- Portfolio Wrapper -->
    <div class="portfolio-box isotope fadeInLeft animated wow grid" style="position: relative; overflow: hidden; height: 480px;display: flex;
    width: 100%;" id="portfolio_wrapper">  
      <!-- Portfolio Item -->
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<img src="img/vue.png" class="img-fluid" alt="">
					<div class="" style="margin: 15px 0;padding: 15px;text-align: justify;">
...
<script src="https://use.fontawesome.com/aa9cd7e03c.js"></script>
